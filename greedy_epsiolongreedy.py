...
class Bandit:
    ...
    def step(self, action):
        # generate the reward under N(q*(At), 1) standard deviation 10
...
def figure_2_1():
    ...
    plt.savefig('/home/akashleena/Documents/20 arm bandit/Bandits_performance_plots/fig_Reward_distribution.png')
    plt.close()
...
def figure_2_2(runs=2000, time=1000):
    ...
    plt.savefig('/home/akashleena/Documents/20 arm bandit/Bandits_performance_plots/fig_egreedy_Avg_reward_optimal_action.png')
    plt.close()
